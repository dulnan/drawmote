              ...
              <ul class="list">
                <li v-for="item in section.items" :key="item.name" class="mrgb">
                  <div v-if="section.name === 'Media'">
                    <h4 class="h4 text-bold"><a :href="item.link" class="link">"{{ item.description }}"</a></h4>
                    by <a :href="item.linkUser" class="link">{{ item.name }}</a>
                    is licensed under <a href="https://creativecommons.org/licenses/by/4.0/" class="link">CC BY 4.0</a>
                  </div>
                  <div v-else>
                    <h4 class="text-bold"><a :href="item.link" class="link">{{ item.name }}</a></h4>
      ...
      sections: [
          ...
          items: [
            {
              ...
              description: 'Figured out and implemented the math for gyro-plane.',
...

        {
          ...
          items: [
            ...
            {
              name: 'gyronorm.js',
              description: 'JavaScript project for accessing and normalizing the accelerometer and gyroscope data on mobile devices',
          ...
          items: [
            {
              ...
              link: 'https://sketchfab.com/3d-models/smartphone-low-poly-free-download-36e8a127e2b9481ea7b4ed4187f2b765'
            },
            {
              name: 'Daniel O\'Neil',
              linkUser: 'https://sketchfab.com/doneil',
              description: 'Monitor w/Star Wars Animation: Household Props 4',
              link: 'https://sketchfab.com/3d-models/monitor-wstar-wars-animation-household-props-4-8ca4aaaf438a44189443e34962a18cd5'
            }
          ]
        }
      ]
